        ...
        <div class="row justify-center">
          <div class="col-xl-9">
            <div class="text-center">
              <h1 data-anim-child="slide-up delay-4" class="text-60 lg:text-40 md:text-30 text-white">The World is Waiting
                For You</h1>
      ...
      <div class="container">
        <div class="row y-gap-30 items-center justify-between">
          ...
          <div class="col-xl-5">
            ...
            <p class="text-dark-1 pr-40 lg:pr-0 mt-15 sm:mt-5">Book in advance or last-minute with GoTrip. Receive instant
        ...
        <div class="row y-gap-30 pt-40">
          ...
          <div data-anim-child="slide-up delay-2" class="col-lg-6">
            <a href="blog-single-1.html" class="row y-gap-20 items-center">
              ...
              <div class="col">
                ...
                <h4 class="text-22 fw-600 text-dark-1 mt-10">10 European ski destinations you should visit this winter
                </h4>
          ...
          <div data-anim-child="slide-up delay-3" class="col-lg-6">
            <a href="blog-single-1.html" class="row y-gap-20 items-center">
              ...
              <div class="col">
                <div class="text-15 text-light-1">April 06, 2022</div>
                <h4 class="text-22 fw-600 text-dark-1 mt-10">Booking travel during Corona: good advice in an uncertain
                  time</h4>
                <p class="mt-10">Ut enim ad minim veniam, quis nostrud exerc ullamco laboris nisi ut aliquip.</p>
              </div>
            </a>
...
function animInit() {
  // Memilih elemen dengan atribut data-anim-child="fade"
  var elementsToAnimate = document.querySelectorAll('[data-anim-child="fade"]');

  elementsToAnimate.forEach(function (element: any) {
    element.style.opacity = '0'; // Mengatur opacity elemen menjadi 0 (tersembunyi)
    element.style.transition = 'opacity 1s'; // Menambahkan transisi opacity

    // Menampilkan elemen dengan animasi fade
    setTimeout(function () {
...
function init() {
  ...
  targets.forEach((eventTarget: any) => {
    ...
    attributes.forEach((el: any) => {
      ...
      if (target) {
        eventTarget.addEventListener('click', () => {
          const toggleClass: any = target.getAttribute('data-x-toggle');
